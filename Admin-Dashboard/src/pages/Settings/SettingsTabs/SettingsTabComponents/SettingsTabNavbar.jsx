...
export default function Navbar() {
  return (
    <nav class="border-b border-gray-200 dark:border-gray-700 mt-6 mb-6 ">
      <ul class="flex flex-wrap -mb-px text-lg font-medium text-center text-gray-500 dark:text-gray-400 ">
        <CustomLink
         to="/settings/profile"
         class="inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg text-white hover:text-green-500 hover:border-gray-300 dark:hover:text-gray-300 group"
         >
        ...
        Account</CustomLink>
        <CustomLink to="/settings/apperance"
        class="inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg text-white hover:text-green-500 hover:border-gray-300 dark:hover:text-gray-300 group"
        >
        ...
        Users</CustomLink>
        <CustomLink to="/settings/display"
        class="inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg text-white hover:text-green-500 hover:border-gray-300 dark:hover:text-gray-300 group"
        >
          <svg class="w-4 h-4 mr-2 text-gray-400 group-hover:text-gray-500 dark:text-gray-500 dark:group-hover:text-gray-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                ...
                Display</CustomLink>
        {/* <CustomLink to="/settings/notifications"
        class="inline-flex items-center justify-center p-4 border-b-2 border-transparent rounded-t-lg text-white hover:text-green-500 hover:border-gray-300 dark:hover:text-gray-300 group"
        >Notifications</CustomLink> */}
      </ul>
    </nav>
  )
}
