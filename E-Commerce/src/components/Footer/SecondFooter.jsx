...
<footer class="bg-black dark:bg-gray-900">
   ...
   {/*  <img src="https://i.ibb.co/vm8jcj2/Download-on-the-App-Store-Get-it-on-Google-Play-Button.png" alt="Download-on-the-App-Store-Get-it-on-Google-Play-Button"
    ...
    <div class="px-4 py-6 bg-black dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span class="text-sm text-white dark:text-gray-300 sm:text-center">© 2023 <a href="https://flowbite.com/">EmaZing™</a>. All Rights Reserved.
        </span>
        <div class="flex mt-4 space-x-5 sm:justify-center md:mt-0">
            <a href="#" class="text-white hover:text-green-600 dark:hover:text-white">
